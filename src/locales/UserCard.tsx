  ...
  return (
    <div className="bg-white shadow-md rounded-lg p-4 mb-4 border-l-4 border-gray-500">
      ...
      <div className="mt-4 pt-4 border-t border-gray-200 flex justify-end gap-3">
        ...
        <button onClick={() => onDelete(user)} className="text-red-600 hover:text-red-900 text-sm font-medium">{t('manageUsers.alerts.deleteNotImplemented').substring(0, 8)}</button>
      </div>
    </div>
  );
}